...
RESOURCES += src/qt/othila.qrc src/qt/othila_locale.qrc

TRANSLATIONS += src/qt/locale/othila_bg.ts \
                src/qt/locale/othila_de.ts \
                src/qt/locale/othila_en.ts \
                src/qt/locale/othila_es.ts \
                src/qt/locale/othila_fi.ts \
                src/qt/locale/othila_fr.ts \
                src/qt/locale/othila_it.ts \
                src/qt/locale/othila_ja.ts \
                src/qt/locale/othila_pl.ts \
                src/qt/locale/othila_pt.ts \
                src/qt/locale/othila_ru.ts \
                src/qt/locale/othila_sk.ts \
                src/qt/locale/othila_sv.ts \
                src/qt/locale/othila_vi.ts \
                src/qt/locale/othila_zh_CN.ts \
                src/qt/locale/othila_zh_TW.ts
