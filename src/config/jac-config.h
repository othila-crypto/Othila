/* src/config/othila-config.h.  Generated from othila-config.h.in by configure.  */
/* src/config/othila-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "othila.org"
