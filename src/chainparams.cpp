...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000168883869671db86254f795b1369f29211ac2bc383346b52fe64c97bc7b"))
    (50000, uint256("0x706d06adc4ed08d4c7e441e3d8483aa6b8816708c79b136fef06083458a45ad2"))
    (100000, uint256("0x836fd7aaea5e4a41b8f0e4a3125ed31c6f59ae931920852982c30c7b1e704de1"))
    (200000, uint256("0x94f7969c654e7d847200f208626bf1d1e2d4451aed99b71167b3562027800cc2"))
    (300000, uint256("0x69e818092751288658163c64236ae15474862b97967e769858203e3f2395cfc7"))
    (400000, uint256("0xe088c6cc3516f439ea1bd5cca8aefd65545141413680c7d1aca703da0562e276"));
    
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1550075412, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 21214;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // OTH starting difficulty is 1 / 2^12
        ...
        const char* pszTimestamp = "Facebook’s Cryptocurrency Is a Nail in the Coffin for 'Blockchain Not Bitcoin'";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1560945554;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 507876;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000168883869671db86254f795b1369f29211ac2bc383346b52fe64c97bc7b"));
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1560945815;
        genesis.nNonce = 368394;
        ...
        // Testnet othila BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet othila BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet othila BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // OTH: 1 day
        nTargetSpacing = 1 * 60;        // OTH: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        
        genesis.nTime = 1560945948;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 4;

        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 21218;
        assert(hashGenesisBlock == uint256("0x0e5e666946ee983e11e60a9691b6f0f44698fa45619908500c24f9a9e25285a1"));
