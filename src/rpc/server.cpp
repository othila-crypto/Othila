...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OTH features */
        {"othila", "masternode", &masternode, true, true, false},
        {"othila", "listmasternodes", &listmasternodes, true, true, false},
        {"othila", "getmasternodecount", &getmasternodecount, true, true, false},
        {"othila", "masternodeconnect", &masternodeconnect, true, true, false},
        {"othila", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"othila", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"othila", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"othila", "masternodecurrent", &masternodecurrent, true, true, false},
        {"othila", "masternodedebug", &masternodedebug, true, true, false},
        {"othila", "startmasternode", &startmasternode, true, true, false},
        {"othila", "createmasternodekey", &createmasternodekey, true, true, false},
        {"othila", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"othila", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"othila", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"othila", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"othila", "getmasternodescores", &getmasternodescores, true, true, false},
        {"othila", "mnsync", &mnsync, true, true, false},
        {"othila", "spork", &spork, true, true, false},
        {"othila", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> othila-cli " + methodname + " " + args + "\n";
}
