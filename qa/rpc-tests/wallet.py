...
#   c) node1 mines 32 blocks, so now node 0 has 60001othila, node 1 has 4250othila, node2 has none.
#   d) node0 sends 601 othila to node2, in two transactions (301 othila, then 300 othila).
