...
In order to support loading of multiple wallets in othila-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is othila.cpp.
...
Changes to othila.cpp
----------------------
othila.cpp is the entry point into othila-qt, and as such, will require some minor modifications to provide hooks for
