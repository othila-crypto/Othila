...
This mechanism has been integrated into Bitcore-Node-OTH which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/OTH-Project/insight-api-othila#web-socket-api](https://github.com/OTH-Project/insight-api-othila#web-socket-api) 
* API: [https://github.com/OTH-Project/insight-api-othila#swifttx-transactions](https://github.com/OTH-Project/insight-api-othila#swifttx-transactions) 
...
By default, the Othila Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Othila Core daemon:
