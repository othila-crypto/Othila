Contributing to Othila Core
============================

The Othila Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Othila Core project, and is not to be
confused with overall OTH Network Protocol consensus changes.

Whether a pull request is merged into Othila Core rests with the project merge
...
Patches that change OTH consensus rules are considerably more involved than
...
Where a patch set proposes to change the OTH consensus, it must have been
...
The project leader is the release manager for each Othila Core release.
